...
import {  listUserAdmin, unmashAdmin, deleteUser, getStatics, showUser} from '../../store/auth/user'; 
...
const UserComponent = () => {
  ...
  const swhoList = () => {
    ...
    const {  userlistAdmin, loading, error } = useSelector((state) => state.user);
        ...
        <div>
            ...
            <div className="top-2 left-2 bg-white shadow-md rounded-lg overflow-hidden">
                <div className="p-4 h-[600px] flex flex-col bg-white bg-opacity-80">
                    <h2 className="text-2xl font-semibold mb-4">Admin lists</h2>
                                                        ...
                                                        <tr key={user.id} className="text-center">
                                                           <td className="border border-gray-300 px-4 py-2 truncate">{user.name}</td>
                                                                ...
                                                                <td className="border border-gray-300 px-4 py-2">
                                                                    ...
                                                                    <button
                                                                        onClick={() => dispatch(unmashAdmin(user.id))}
